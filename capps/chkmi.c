...
// #define IDR_ICON_ON  101
// #define IDR_ICON_OFF 102
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    ...
    wc.lpszClassName = "MacronHotkeyWnd";
    RegisterClass(&wc);

    HWND hwnd = CreateWindowEx(0, "MacronHotkeyWnd", "MacronHotkeys", 0, 0, 0, 0, 0,
                               NULL, NULL, hInstance, NULL);

    // hIconOn  = (HICON)LoadImage(hInstance, MAKEINTRESOURCE(IDR_ICON_ON), IMAGE_ICON, 16, 16, LR_DEFAULTCOLOR);
    // hIconOff = (HICON)LoadImage(hInstance, MAKEINTRESOURCE(IDR_ICON_OFF), IMAGE_ICON, 16, 16, LR_DEFAULTCOLOR);

    // hIconOn  = LoadIcon(hInstance, MAKEINTRESOURCE(IDR_ICON_ON));
    // hIconOff = LoadIcon(hInstance, MAKEINTRESOURCE(IDR_ICON_OFF));
    // nid.hIcon = hIconOn;

HICON hIcon = (HICON)LoadImage(hInstance, MAKEINTRESOURCE(IDR_ICON1), IMAGE_ICON, 16, 16, LR_DEFAULTCOLOR);

    // HICON hIcon  = LoadIcon(hInstance, MAKEINTRESOURCE(IDR_ICON1));
    nid.hIcon = hIcon;
